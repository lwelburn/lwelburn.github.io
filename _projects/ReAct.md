...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ReAct/ReAct2.png" title="ReAct2" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ReAct/nullConfig.png" title="nullConfig" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/ReAct/workspace.png" title="workspace" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Null configuration and reachable workspace for a single finger.
</div>
